...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final body = SafeArea(
      child: StreamBuilder(
          stream: Firestore.instance.collection(Constants.PREFEITO).snapshots(),
          builder: (ctx, snapshot) {
            ...
            final prefeito =
                Prefeito().fromDocumentsSnapshot(querySnapshot.documents).first;
            return Column(
              children: <Widget>[
                Container(
                ...
                Expanded(
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      //         width: 120,
                      //       ),
                      //       Text('Plano de Governo...', style: TextStyle(fontSize: Theme.of(context).textTheme.bodyText1.fontSize)),
